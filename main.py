...
# Input Data
Task = input('Task type (1 - Side task; 2 - End task): ')
R = float(input('Radius of the tank, m: '))
H = float(input('Height of the tank, m: '))
if Task == 1:
    h = float(input('Height level of the reference point, m: '))
d = float(input('Protection thickness, cm: '))
dt = input('Protection material (1 - Concrete; 2 - Lead; 3 - Iron): ')
...
E = input('Gamma energy, MeV: ')


# Tables
tab_mat = ['Water', 'Concrete', 'Lead', 'Iron']
